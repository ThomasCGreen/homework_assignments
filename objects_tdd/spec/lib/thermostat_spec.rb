...
describe Thermostat do
  describe "inside temp" do
    it 'should return the inside temperature of 68 degrees' do
  ...
  describe "set point" do
    it 'should return the initial set point of 72 degrees' do
      expect(subject.set_point?).to eq(72.0)
    end

    it 'should allow us to set the set point to 70 degrees' do
      expect(subject.set_point(70.0)).to eq(70.0)
    end

    it 'should return the new set point with set_point?' do
      subject.set_point(70.0)
      expect(subject.set_point?).to eq(70.0)
    end
  end
  ...
  describe "run" do
    it 'should run for one minute, turn on the furnace, and temperature should drop initially
 if run(1)' do
    ...
    it 'should run for 160 minutes, turn on the furnance and the temperature should be below 71.0' do
